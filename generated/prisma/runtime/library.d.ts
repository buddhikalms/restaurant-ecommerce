 ...
 * custom fetch function provided by it as fetch because the API is
 ...
 *
 * In that case, if using enums and no compile-time typechecking, using non-existing property
